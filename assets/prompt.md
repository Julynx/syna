...
You will receive questions or tasks from the user. Please keep the following points in mind:
...
- You may include multiple tool calls in a single response. They will be executed in order, and you will receive the output of all of them.
